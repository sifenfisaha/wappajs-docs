---
title: Cloud API
description: The official WhatsApp Cloud API transport. Covers the Meta dashboard walkthrough, webhook server, signature verification, and message mapping.
---

`CloudApiTransport` (`@wappajs/cloud-api`) speaks the **official WhatsApp Cloud API**:
