---
title: Baileys
description: Run a bot on a personal WhatsApp number via QR login with @wappajs/baileys. Covers auth persistence, reconnects, and ToS caveats.
---

`BaileysTransport` (`@wappajs/baileys`) runs your bot on a **personal WhatsApp number**
...
<Callout type="warn" title="Legal / ToS warning">
  ...
  **can get phone numbers banned**. Use a number you can afford to lose, and prefer the
  official Cloud API transport ([`@wappajs/cloud-api`](/docs/transports/cloud-api)) for
  production.
</Callout>
