---
title: Recipes
description: Practical patterns built from the core primitives, covering handoff, media, group mentions, proactive messages, transcription, rate limits, and buttons.
---
